...
fixie = (
    function () {
        ...
        var docDefined = function () {
            return typeof document !== 'undefined';
        };


        if (docDefined() && typeof document.getElementsByClassName !== 'function') {
...
function init_str(selector_str) {
    if (docDefined() && !document.querySelectorAll) {
        return false;
    }
    try {
...
return {
    ...
    'fetchPhrase': def || fixie_fetchPhrase,
    'fetchSentence': def || fixie_fetchSentence,
    'fetchParagraph': def || fixie_fetchParagraph,
    'fetchParagraphs': def || fixie_fetchParagraphs
};
